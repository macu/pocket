<template>
<div class="pocket-app" :class="{'is-mobile': isMobile}">

	<header class="flex-row-md">
		<h1 class="flex-1">
			<span v-if="onDashboard">Pocket</span>
...
.pocket-app {
	...
	>.body {
		...
		background: linear-gradient(to bottom, $app-separator-color, transparent 10px), transparent;
